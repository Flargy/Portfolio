...
public class CameraScript: MonoBehaviour
{
    ...
    protected void CameraPosition()
    {
        ...
        //Debug.DrawRay(transform.position, point.normalized, );
        ...
        //playerView.transform.position = playerView.transform.rotation * startLocation + playerView.transform.position;
    }
    ...
    protected void ZoomHandler()
    {
        ...
        if(Input.GetAxisRaw("Zoom") < 0 || Input.GetButton("Zoom out"))//if RB do this
        {
           ...
           // playerView.transform.localPosition -= zoomOffset * Time.deltaTime;
        ...
        if (changed)
        {
            if (cameraDistance.z > -2)
                ...
                cameraDistance.z = -8;
          //  DistanceReached(); fixar så att view inte går bort från spelaren
        }
        //Debug.Log("Mouse scroll input" + cameraDistance.z);
    }
