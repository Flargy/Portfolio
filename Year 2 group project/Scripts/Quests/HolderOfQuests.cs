...
public class HolderOfQuests : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //Tutorial
        //reward 0 är en fackla
        quests.Add(1, new Quest(1, 0
        ...
        , "Kan du göra mig en tjänst till när du ändå är farten? Det börjar nämligen bli ensamt här i dammen." +  
        "Allt som närmar sig är bara ointressanta smådjur. Grodor, trollsländor, BLÄ!! Jag behöver intelligent sällskap." + 
        "\nHittar du något smartare än dessa djur så lovar jag att återbetala dig." 
        , "Hmm, det är inte drömpartnern jag hade i åtanke men det är bättre än de alternativ jag har idag.\nTack, Frigga." + 
        ...
        ,"Har du hittat något smartare än en groda än? Inte helt lätt i denna värld ska sägas..."
        ,"Ett sällskapssjukt väsen",
        new QuestGoal(GoalType.Escort, 1, 0)));
