...
public class PlayerBaseState : State
{
    ...
    protected AudioClip StunGiantSound { get { return owner.StunGiantSound; } }
    ...
    public override void Update()
    {
        ...
        //MovePlayer();
        //Position.eulerAngles = new Vector3(0, Camera.main.transform.rotation.eulerAngles.y, 0);
        ...
        //{
        //    pointDown = Position.position;
        //    pointDown.y = -1;
        //    Physics.Linecast(Position.position, pointDown, out capsuleRaycast, LayerMask.GetMask("Default"));
        //    GameObject Go = Instantiate(Bonfire, capsuleRaycast.point, Quaternion.identity);
        //}
    ...
    {
        ShoutEventInfo sei = new ShoutEventInfo { playerPosition = Position.position, shoutDuration = time};
    ...
    /// <summary>
    /// Checks the conditions for when the player should start decelerating.
    /// </summary>
    public void DecelerateCheck()
    {
